...
3. URL、取得日、作者、要点、リスク、実験候補を書く
4. 実験に使ったら `SESSION_NOTES.md` に出典を書く
5. 提出に効いたら `submit/SUBMISSIONS.md` にも出典を書く
...
5. 図表、OOF、モデルなどの生成物は `results/` に置く
6. 結果、判断、次アクションを `SESSION_NOTES.md` に残す
